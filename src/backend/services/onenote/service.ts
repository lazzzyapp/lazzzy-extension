...
import { UserInfo, UnauthorizedError } from '../interface';
...
export default class OneNoteDocumentService
  implements DocumentService<OneNoteBackendServiceConfig> {
   ...
   * @param {string} groupId for notebook id.
